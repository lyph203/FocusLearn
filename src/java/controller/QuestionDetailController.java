...
public class QuestionDetailController extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        int totalAnswer = questionDAO.getTotalAnswerByQuestionId(questionId);
        List<Tag> listTag = questionDAO.getListTagByQuestionId(questionId);
        ...
        List<Answer> listAnswer = answerDAO.getListAnswerByQuestionId(questionId, index);
