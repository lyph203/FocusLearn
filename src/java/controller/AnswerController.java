 ...
 * @author Admin
 */
@WebServlet(name="AnswerController", urlPatterns={"/answer"})
public class AnswerController extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        answer.setQuestion(new QuestionDAO().getQuestionByID(Integer.parseInt(questionId)));
        answer.setUser((User) request.getSession().getAttribute("user"));
        answerDAO.addNewAnswer(answer);
        request.setAttribute("id", questionId);
        request.getRequestDispatcher("questiondetail").forward(request, response);
    } 
